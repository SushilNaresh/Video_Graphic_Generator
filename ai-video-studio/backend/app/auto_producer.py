    ...
    log = [
        {
            ...
            "end": graphic.end,
            "track": graphic.track,
            "reason": graphic.parameters.get("visual_reasoning", "Generated by local semantic trigger engine."),
        }
        for graphic in project.graphics
    ]
    write_json(ensure_project_dirs(project.id) / "thumbnails" / "visual_reasoning_log.json", log)
    return project
